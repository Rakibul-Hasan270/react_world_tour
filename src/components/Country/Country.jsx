...
const Country = ({ country, handelVisitedCountries, handelVisitedCountriesFlag }) => {
    ...
    return (
        <div className='country'>
            ...
            <button onClick={() => handelVisitedCountriesFlag(country?.flags?.png)}>Mark Visit Flag</button>
